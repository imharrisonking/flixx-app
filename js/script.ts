const global = {
    ...
    api: {
        apiKey: '6914b9f184c05b3e80d856880f362424',
...
async function getShowDetails() {
    ...
    <div class="details-bottom">
        <h2>Show Info</h2>
        <ul>
        <li><span class="text-secondary">Number of Episdoes:</span> ${show.number_of_episodes}</li>
...
// Show alert
function showAlert(message: string, className: string = 'error') {
